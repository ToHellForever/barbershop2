...
from core.views import landing, thanks, thanks_form, orders_list, order_detail, services_views, masters_views, review_create, order_create
...
urlpatterns = [
    ...
    path('thanks_form/', views.thanks_form, name='thanks_form') # Страница благодарности для отзыва
] + debug_toolbar_urls()
